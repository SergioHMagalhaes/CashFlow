...
public class GenerateExpensesReportPdfUseCase : IGenerateExpensesReportPdfUseCase
{
    ...
    public async Task<byte[]> Execute(DateOnly month)
    {
        ...
        CreateHeaderWhithProfilePhotoAndName(page);
    ...
    private Document CreateDocument(DateOnly month)
    {
        ...
        document.Info.Author = "Sérgio Magalhães";
    ...
    private void CreateHeaderWhithProfilePhotoAndName(Section page)
    {
        ...
        row.Cells[1].AddParagraph("Hey, Sérgio");
